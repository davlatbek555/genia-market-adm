            ...
            <div className="category-head">
              ...
              <div className='category-head__row'>
                <select name='category' className='category-head__select' id="categories" onChange={handleAasc}>
                  <option value="none" className='category-head__selects' >Hech kaysi</option>
                  <option value="asc" className='category-head__selects' >Arzon</option>
                  <option value="desc" className='category-head__select' >Qimmat</option>
            ...
            <div className="category-products__top">
              {
                brands.list.filter(item => filteredBrands.includes(item.id)).map(item => (
                  <button className="category-products__top__button" key={item.id} >
                    <span>{item.title}</span>
                    <span><CloseIcon  onClick={() => handleBrandDelete(item.id)}/> </span> 
                  </button>
                ))
              }
